...
class GmarketCategoryAllSpider(scrapy.Spider):
    ...
    def parse_items(self, response):
        ...
        for index, item in enumerate(best_items[1].css('li')):
            ...
            doc['maincategory_name'] = response.meta['main_category_name']
            doc['subcategory_name'] = response.meta['sub_category_name']
            doc['ranking'] = ranking
            doc['title'] = title
            doc['oprice'] = ori_price
            doc['dprice'] = dis_price
            doc['discount'] = discount_percent
